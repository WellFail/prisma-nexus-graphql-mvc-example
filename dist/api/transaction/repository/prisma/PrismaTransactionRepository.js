...
const TransactionMap_1 = require("../../mappers/TransactionMap");
...
let PrismaTransactionRepository = class PrismaTransactionRepository {
    ...
    async getAllTransactions() {
        ...
        return transactions.map((transaction) => TransactionMap_1.TransactionMap.toDomain(transaction));
    }
    createTransaction(transaction) {
        throw new Error('Method not implemented.');
    }
};
PrismaTransactionRepository = __decorate([
...
//# sourceMappingURL=PrismaTransactionRepository.js.map